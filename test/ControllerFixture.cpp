...
protected:
    virtual void SetUp(){
        ...
        tab->getTable()->SetValue(1, 2, wxString::Format(wxT("%g"), 1.2));
        tab->getTable()->SetValue(1, 3, wxString::Format(wxT("%g"), 5.3));
        tab->getTable()->SetValue(2, 1, wxString::Format(wxT("%g"), 1.2));
        tab->getTable()->SetValue(3, 1, wxString::Format(wxT("%g"), 5.3));
    }
